...
#define TASKBAR_ROW   (w2k_theme == THEME_CLASSIC ? 28 : \
                       (w2k_theme == THEME_BASIC7 || w2k_theme == THEME_AERO) ? (w2k_taskbar_small ? 30 : 40) : \
                       w2k_theme == THEME_MODERN ? 28 : \
                       w2k_theme == THEME_VISTA ? 30 : 30)
...
enum {
    SM_UPDATE = 100,
    SM_EXPLORER, SM_NOTEPAD, SM_TASKMGR, SM_CALC, SM_PAINT, SM_TERMINAL, SM_SNIP, SM_DEVMGMT, SM_DISKMGMT, SM_LINVER,
    ...
    SM_CLEARDOCS, SM_SYSPROPS, SM_CLEANUP, SM_PROTON,
